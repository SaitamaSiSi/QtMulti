...
cmake .. -DCMAKE_INSTALL_PREFIX=${outdir_x86} -DBUILD_SHARED_LIBS=ON -DCMAKE_BUILD_TYPE=Release -DDEMO=OFF
cmake --build . --config Release
cmake --build . --config Release --target install

# generate static library(lib)
cmake .. -DCMAKE_INSTALL_PREFIX=${outdir_x86} -DBUILD_SHARED_LIBS=OFF -DCMAKE_BUILD_TYPE=Release -DDEMO=OFF
cmake --build . --config Release
cmake --build . --config Release --target install
